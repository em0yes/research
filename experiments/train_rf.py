...
class ZoneClassifierWithSlidingWindow:
    def __init__(self, window_size_rows=5, step_size_rows=5, n_estimators=100):
        # RandomForestClassifier 초기화 (기본 설정 사용)
    ...
    def train_model(self):
        """
        학습 데이터를 통해 RandomForest 모델을 학습합니다.
        """
...
def main(train_file, test_file, model_name, report_file):
    # 슬라이딩 윈도우 기반 분류기 인스턴스 생성 (랜덤포레스트 사용)
    classifier = ZoneClassifierWithSlidingWindow(window_size_rows=5, step_size_rows=1, n_estimators=100)  # 100개의 트리
